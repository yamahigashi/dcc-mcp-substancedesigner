...
class SceneLifecycleCommandMixin:
    ...
    def create_package(self, file_path: str | None = None) -> JsonMap:
        ...
        return create_package_payload(host._pkg_mgr(), file_path)
    ...
    def create_graph(
        ...
        return create_graph_payload(new_composition_graph, pkg, graph_name)
    ...
    def delete_graph(self, graph_identifier: str, package_index: int = 0) -> JsonMap:
        ...
        return delete_graph_payload(pkg, graph_identifier)
    ...
    def open_graph(self, graph_identifier: str) -> JsonMap:
        ...
        return open_graph_payload(host._ui_mgr(), graph, graph_identifier)
    ...
    def save_package(
        ...
        host = cast(SceneCommandHost, self)
        pkg = host._resolve_package(package_index, package_path)
        return save_package_payload(host._pkg_mgr(), pkg, file_path)
